...
INTENT_KEYWORDS = {
    ...
    "finance": ["expense", "expenses", "spending", "spendings", "spent", "spend", "spend on", "spends", "money", "budget", "finance", "financial", "tracker", "how much did i", "how much have i", "monthly", "category breakdown", "plot my", "chart my", "recommend", "trip spending", "japan trip", "summary report", "graph", "plot", "chart", "visualize", "visualise", "compare my", "comparison of my", "timeline", "superimposed", "breakdown"],
    "code": ["review my code", "review the code", "review this file", "review code", "code review", "comment my code", "comment this file", "add comments", "auto comment", "commit message", "generate a commit", "git commit", "diagnose this error", "debug this", "fix this error", "fix the error", "fix the errors", "fix these errors", "refactor", "is this too long", "review the file at", "comment the file at"],
...
def classify_intent(text: str, session_state=None) -> str:
    ...
    best_intent, best_len = None, -1 #Classify a best intent (dominant intent from the phrase if ever more keywords are present)
