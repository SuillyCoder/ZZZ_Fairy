...
INTENT_KEYWORDS = {
    ...
    "finance": ["expense", "expenses", "spending", "spendings", "spent", "money", "budget",
                "finance", "financial", "tracker", "how much did i", "how much have i",
                "monthly", "category breakdown", "plot my", "chart my", "recommend",
                "trip spending", "japan trip", "summary report",
                "graph", "plot", "chart", "visualize", "visualise", "compare my",
                "comparison of my", "timeline", "superimposed", "breakdown"],
